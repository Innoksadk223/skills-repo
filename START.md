...
> 如果你只想听总览，我会讲最短版；也可以选一个方向深入讲：浏览器自动化、论文写作、知识库/Obsidian、文档生成、实时搜索、学术搜索、通用方法论、工具类技能。

介绍时：

1. 先用「一句话原则」说明：**用户只管说目标，AI 负责挑技能。**
2. 先给最短总览和 3-5 个常用说法示例，不要一次灌输全部细节。
...
4. 对复杂组单独追问：
   ...
   - **通用方法论 / Superpowers**：说明它是轻量版工作方法工具箱，轻量化的是入口和流程，不是降低触发条件；适合澄清目标、写计划、排查问题、验收完成、隔离工作区、委派任务、代码审查和分支收尾。
