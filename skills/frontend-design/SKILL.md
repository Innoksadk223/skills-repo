...
description: Generates distinctive, high-quality frontend designs avoiding generic AI aesthetics. Use when building landing pages, UI components, dashboards, web apps, or any frontend/web design task.
---
...
- Minimal animations / static designs
